...
RUN apt-get update \
    ...
    && ln -s /opt/venv/bin/SniperCallsBot SniperCallsBot # Make sure we use the virtualenv \
    && chmod +x docker-entrypoint.sh

VOLUME /SniperCallsbot/backtesting
VOLUME /SniperCallsbot/logs
VOLUME /SniperCallsbot/tentacles
VOLUME /SniperCallsbot/user
