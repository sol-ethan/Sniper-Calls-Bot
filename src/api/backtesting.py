...
import SniperCallsbot_backtesting.constants as constants
...
def check_independent_backtesting_remaining_objects(independent_backtesting) -> None:
    independent_backtesting.SniperCallsbot_backtesting.check_remaining_objects()
...
def get_independent_backtesting_exchange_manager_ids(independent_backtesting) -> list:
    return independent_backtesting.SniperCallsbot_backtesting.exchange_manager_ids


def get_independent_backtesting_bot_id(independent_backtesting) -> str:
    return independent_backtesting.SniperCallsbot_backtesting.bot_id
...
def get_independent_backtesting_config(independent_backtesting) -> dict:
    return independent_backtesting.SniperCallsbot_backtesting.backtesting_config


def get_independent_backtesting_symbols_by_exchanges(independent_backtesting) -> dict:
    return independent_backtesting.SniperCallsbot_backtesting.symbols_to_create_exchange_classes
