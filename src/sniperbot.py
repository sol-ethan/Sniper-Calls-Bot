...
import SniperCallsbot_commons.signals as signals
import SniperCallsbot_commons.databases as databases
import SniperCallsbot_commons.tree as commons_tree
import SniperCallsbot_commons.os_clock_sync as os_clock_sync
import SniperCallsbot_commons.system_resources_watcher as system_resources_watcher
import SniperCallsbot_commons.aiohttp_util as aiohttp_util
import SniperCallsbot_commons.profiles as profiles
...
class SniperCallsBot:
    ...
    def __init__(self, config: configuration.Configuration, community_authenticator=None,
        ...
        # Used to know when SniperCallsBot is ready to answer in APIs
        ...
        # SniperCallsbot_api to request the current instance
        self.SniperCallsbot_api = SniperCallsbot_api.SniperCallsBotAPI(self)

        # SniperCallsbot channel global consumer
        self.global_consumer = SniperCallsbot_channel_consumer.SniperCallsBotChannelGlobalConsumer(self)

        # SniperCallsbot instance id
        ...
        # Initialize SniperCallsbot main tools
    ...
    async def initialize(self):
        ...
        await logger.init_SniperCallsbot_chan_logger(self.bot_id)
    ...
    async def create_producers(self):
        self.exchange_producer = producers.ExchangeProducer(self.global_consumer.SniperCallsbot_channel, self,
                                                            None, self.ignore_config)
        self.evaluator_producer = producers.EvaluatorProducer(self.global_consumer.SniperCallsbot_channel, self)
        self.interface_producer = producers.InterfaceProducer(self.global_consumer.SniperCallsbot_channel, self)
        self.service_feed_producer = producers.ServiceFeedProducer(self.global_consumer.SniperCallsbot_channel, self)
    ...
    def _init_community(self):
        self.community_handler = community.CommunityManager(self.SniperCallsbot_api)
    ...
    async def delayed_restart(self, delay):
        ...
        self.SniperCallsbot_api.restart_bot()
    ...
    def _log_config(self):
        ...
        self.logger.info(f"Starting SniperCallsBot with {trader_str} on "
