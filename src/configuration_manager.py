...
import SniperCallsbot_commons.json_util as json_util
...
def config_health_check(config: configuration.Configuration, in_backtesting: bool) -> configuration.Configuration:
    ...
    if not (in_backtesting or
        ...
        logger.error(f"Real trader and trader simulator are deactivated in configuration. This will prevent SniperCallsBot "
...
def get_default_tentacles_url(version=None):
    ...
    return os.getenv(
        ...
        f"{constants.SniperCallsBOT_ONLINE}/"
