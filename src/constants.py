...
# SniperCallsBot urls
SniperCallsBOT_WEBSITE_URL = os.getenv("SniperCallsBOT_ONLINE_URL", "https://www.SniperCallsbot.cloud")
SniperCallsBOT_DOCS_URL = os.getenv("DOCS_SniperCallsBOT_ONLINE_URL", "https://www.SniperCallsbot.cloud/en/guides")
EXCHANGES_DOCS_URL = os.getenv("DOCS_SniperCallsBOT_ONLINE_URL", "https://www.SniperCallsbot.cloud/en/guides/exchanges/")
DEVELOPER_DOCS_URL = os.getenv("DOCS_SniperCallsBOT_ONLINE_URL", "https://www.SniperCallsbot.cloud/en/guides/developers/")
SniperCallsBOT_ONLINE = os.getenv("TENTACLES_SniperCallsBOT_ONLINE_URL", "SniperCallsbot.online")
SniperCallsBOT_FEEDBACK = os.getenv("FEEDBACK_SniperCallsBOT_ONLINE_URL", "https://feedback.SniperCallsbot.cloud/")
...
SniperCallsBOT_BETA_PROGRAM_FORM_URL = "https://click.SniperCallsbot.cloud/docs-join-beta"
...
COMMUNITY_TRADINGVIEW_WEBHOOK_BASE_URL = os.getenv(
    "COMMUNITY_TRADINGVIEW_WEBHOOK_BASE_URL", "https://webhook.SniperCallsbot.cloud/tradingview"
)
COMMUNITY_EXTENSIONS_IDENTIFIER = "scaleway"
COMMUNITY_EXTENSIONS_CHECK_ENDPOINT = os.getenv(
    "COMMUNITY_EXTENSIONS_CHECK_ENDPOINT", "https://premium.SniperCallsbot.cloud"
)
...
SniperCallsBOT_COMMUNITY_LANDING_URL = os.getenv("COMMUNITY_SERVER_URL", "https://SniperCallsbot.cloud")
SniperCallsBOT_COMMUNITY_API_URL = os.getenv("COMMUNITY_SERVER_URL", f"{SniperCallsBOT_COMMUNITY_LANDING_URL}/api/community")
SniperCallsBOT_COMMUNITY_URL = os.getenv("COMMUNITY_SERVER_URL", "https://app.SniperCallsbot.cloud")
...
STAGING_SniperCallsBOT_COMMUNITY_LANDING_URL = os.getenv("COMMUNITY_SERVER_URL", "https://beta.SniperCallsbot.cloud")
STAGING_SniperCallsBOT_COMMUNITY_API_URL = os.getenv("COMMUNITY_SERVER_URL", f"{STAGING_SniperCallsBOT_COMMUNITY_LANDING_URL}/api/community")
STAGING_SniperCallsBOT_COMMUNITY_URL = os.getenv("COMMUNITY_SERVER_URL", "https://app-beta.SniperCallsbot.cloud/")
STAGING_COMMUNITY_RECOVER_PASSWORD_URL = STAGING_SniperCallsBOT_COMMUNITY_URL
...
# errors
ERRORS_URL = os.getenv("ERRORS_SniperCallsBOT_ONLINE_URL", "https://errors.SniperCallsbot.online/")
