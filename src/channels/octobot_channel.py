...
class SniperCallsBotChannelConsumer(consumers.Consumer):
    """
    Consumer adapted for SniperCallsBotChannel
    """


class SniperCallsBotChannelProducer(producers.Producer):
    """
    Producer adapted for SniperCallsBotChannel
    """
...
class SniperCallsBotChannel(channels.Channel):
    """
    Channel used to communicate SniperCallsBot high level events
    """
    PRODUCER_CLASS = SniperCallsBotChannelProducer
    CONSUMER_CLASS = SniperCallsBotChannelConsumer
    ...
    async def new_consumer(self,
                           ...
                           action: object = channel_constants.CHANNEL_WILDCARD) -> SniperCallsBotChannelConsumer:
        """
        Creates a new SniperCallsBot Channel consumer
        ...
        """
        consumer = SniperCallsBotChannelConsumer(callback, size=size, priority_level=priority_level)
    ...
    async def _add_new_consumer_and_run(self, consumer,
        ...
        """
        Add and run a created SniperCallsBot channel consumer
