...
import src.strategy_optimizer as SniperCallsbot_strategy_optimizer
import src.backtesting as SniperCallsbot_backtesting
...
class StrategyTestSuite(SniperCallsbot_backtesting.AbstractBacktestingTest):
    ...
    def get_test_suite_result(self):
        return SniperCallsbot_strategy_optimizer.TestSuiteResult(self._profitability_results,
                                                          self._trades_counts,
    ...
    def _handle_results(self, independent_backtesting, profitability):
        ...
        if independent_backtesting is not None:
            exchange_manager_ids = SniperCallsbot_backtesting_api.get_independent_backtesting_exchange_manager_ids(
    ...
    async def _run_backtesting_with_current_config(self, data_file_to_use):
        ...
        try:
            ...
            await SniperCallsbot_backtesting_api.initialize_and_run_independent_backtesting(independent_backtesting, log_errors=False)
            await SniperCallsbot_backtesting_api.join_independent_backtesting(independent_backtesting)
