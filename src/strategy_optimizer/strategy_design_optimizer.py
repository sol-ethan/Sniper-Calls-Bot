#  Drakkar-Software SniperCallsBot
...
import src.strategy_optimizer.optimizer_settings as optimizer_settings_import
import src.strategy_optimizer.optimizer_filter as optimizer_filter
...
import SniperCallsbot_commons.multiprocessing_util as multiprocessing_util
import SniperCallsbot_commons.databases as databases
import SniperCallsbot_commons.dict_util as dict_util
import SniperCallsbot_backtesting.errors as backtesting_errors
...
import SniperCallsbot_services.api as services_api
import SniperCallsbot_services.enums as services_enums
...
class StrategyDesignOptimizer:
    ...
    async def _run_with_config(self, optimizer_id, data_files, run_id, run_config,
        ...
        try:
            import src.api.backtesting as SniperCallsbot_backtesting_api
            # reset possible remaining caches
            await databases.CacheManager().reset()
            config_to_use = copy.deepcopy(self.config)
            independent_backtesting = SniperCallsbot_backtesting_api.create_independent_backtesting(
                config_to_use,
                tentacles_setup_config,
                data_files,
                start_timestamp=start_timestamp,
            ...
            await SniperCallsbot_backtesting_api.initialize_and_run_independent_backtesting(independent_backtesting,
                                                                                     log_errors=False)
            await SniperCallsbot_backtesting_api.join_independent_backtesting(independent_backtesting, timeout=None)
