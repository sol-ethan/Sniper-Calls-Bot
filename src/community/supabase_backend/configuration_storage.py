...
import typing
import gotrue
import SniperCallsbot_commons.configuration
import SniperCallsbot_commons.logging
...
class SyncConfigurationStorage(gotrue.SyncSupportedStorage):
    ...
    """
    def __init__(self, configuration: SniperCallsbot_commons.configuration.Configuration):
        self.configuration: SniperCallsbot_commons.configuration.Configuration = configuration
    ...
    def _save_value_in_config(self, key, value):
        if self.configuration is not None:
            ...
            try:
                ...
                SniperCallsbot_commons.logging.get_logger(self.__class__.__name__).exception(
