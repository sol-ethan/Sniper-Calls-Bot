...
import src.community.supabase_backend.postgres_functions as postgres_functions
import src.community.supabase_backend.supabase_realtime_client as supabase_realtime_client
...
class AuthenticatedAsyncSupabaseClient(supabase.Client):
    ...
    - auth token refresh
    - realtime client
    There should not be SniperCallsBot specific code here
    """
