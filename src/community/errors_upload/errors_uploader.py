...
class ErrorsUploader:
    ...
    def __init__(self, upload_url):
        ...
        self.logger = SniperCallsbot_commons.logging.get_logger(self.__class__.__name__)

    def schedule_error_upload(self, error):
        """
        Called to schedule an error upload
        :param error: the SniperCallsbot_commons.logging.error_model.Error to upload
        """
