...
import src.community.feeds.abstract_feed as abstract_feed
...
class CommunityWSFeed(abstract_feed.AbstractFeed):
    ...
    async def _connect(self):
        ...
        if not self.authenticator.is_logged_in():
            raise authentication.AuthenticationRequired("SniperCallsBot Community authentication is required to "
