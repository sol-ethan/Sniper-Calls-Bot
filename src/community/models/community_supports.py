...
import SniperCallsbot_commons.support as support


class CommunitySupports(support.Support):
    DEFAULT_SUPPORT_ROLE = "default"
    SniperCallsBOT_DONOR_ROLE = "donor"
    ...
    def is_donor(self) -> bool:
        return self.support_role == self.SniperCallsBOT_DONOR_ROLE or bool(self.donations)
